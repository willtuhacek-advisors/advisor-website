      ...
      <section className="bg-navy">
        <div className="mx-auto max-w-5xl px-6 py-28 text-center">
          ...
          <div className="mt-10">
            <Link
              href="/contact"
              className="inline-flex items-center justify-center rounded-full bg-gold px-6 py-3 text-sm font-semibold text-navy-dark hover:bg-gold-dark"
            >
      ...
      <section className="bg-gray-50">
        <div className="mx-auto max-w-5xl px-6 py-20 text-center">
          ...
          <div className="mt-8 flex justify-center gap-4">
            <Link
              href="/about"
              className="rounded-full border-2 border-navy px-6 py-3 text-sm font-semibold text-navy hover:bg-navy hover:text-white"
            >
              About me
            </Link>
            <Link
